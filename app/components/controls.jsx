      ...
      <>
        <Modal visible={showModal} close={() => setShowModal(false)}>
          ...
          <div class="md:grid grid-cols-2 gap-10">
            <div>
              <p className="mb-4">Currently running at 2592000x the speed of Earth's orbit</p>
              <p className="mb-4">Every second in model Earth's orbit is 0.0821 Earth-years passing.</p>
            </div>
            <div>
